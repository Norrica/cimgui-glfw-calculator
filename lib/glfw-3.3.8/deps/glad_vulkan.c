...
PFN_vkEnumerateInstanceExtensionProperties
    glad_vkEnumerateInstanceExtensionProperties = NULL;
...
PFN_vkGetDeviceBufferMemoryRequirements
    glad_vkGetDeviceBufferMemoryRequirements = NULL;
PFN_vkGetDeviceGroupPeerMemoryFeatures glad_vkGetDeviceGroupPeerMemoryFeatures =
    NULL;
PFN_vkGetDeviceGroupPresentCapabilitiesKHR
    glad_vkGetDeviceGroupPresentCapabilitiesKHR = NULL;
PFN_vkGetDeviceGroupSurfacePresentModesKHR
    glad_vkGetDeviceGroupSurfacePresentModesKHR = NULL;
PFN_vkGetDeviceImageMemoryRequirements glad_vkGetDeviceImageMemoryRequirements =
    NULL;
PFN_vkGetDeviceImageSparseMemoryRequirements
    glad_vkGetDeviceImageSparseMemoryRequirements = NULL;
PFN_vkGetDeviceMemoryCommitment glad_vkGetDeviceMemoryCommitment = NULL;
PFN_vkGetDeviceMemoryOpaqueCaptureAddress
    glad_vkGetDeviceMemoryOpaqueCaptureAddress = NULL;
...
PFN_vkGetImageSparseMemoryRequirements2
    glad_vkGetImageSparseMemoryRequirements2 = NULL;
PFN_vkGetImageSubresourceLayout glad_vkGetImageSubresourceLayout = NULL;
PFN_vkGetInstanceProcAddr glad_vkGetInstanceProcAddr = NULL;
PFN_vkGetPhysicalDeviceExternalBufferProperties
    glad_vkGetPhysicalDeviceExternalBufferProperties = NULL;
PFN_vkGetPhysicalDeviceExternalFenceProperties
    glad_vkGetPhysicalDeviceExternalFenceProperties = NULL;
PFN_vkGetPhysicalDeviceExternalSemaphoreProperties
    glad_vkGetPhysicalDeviceExternalSemaphoreProperties = NULL;
PFN_vkGetPhysicalDeviceFeatures glad_vkGetPhysicalDeviceFeatures = NULL;
PFN_vkGetPhysicalDeviceFeatures2 glad_vkGetPhysicalDeviceFeatures2 = NULL;
PFN_vkGetPhysicalDeviceFormatProperties
    glad_vkGetPhysicalDeviceFormatProperties = NULL;
PFN_vkGetPhysicalDeviceFormatProperties2
    glad_vkGetPhysicalDeviceFormatProperties2 = NULL;
PFN_vkGetPhysicalDeviceImageFormatProperties
    glad_vkGetPhysicalDeviceImageFormatProperties = NULL;
PFN_vkGetPhysicalDeviceImageFormatProperties2
    glad_vkGetPhysicalDeviceImageFormatProperties2 = NULL;
PFN_vkGetPhysicalDeviceMemoryProperties
    glad_vkGetPhysicalDeviceMemoryProperties = NULL;
PFN_vkGetPhysicalDeviceMemoryProperties2
    glad_vkGetPhysicalDeviceMemoryProperties2 = NULL;
PFN_vkGetPhysicalDevicePresentRectanglesKHR
    glad_vkGetPhysicalDevicePresentRectanglesKHR = NULL;
PFN_vkGetPhysicalDeviceProperties glad_vkGetPhysicalDeviceProperties = NULL;
PFN_vkGetPhysicalDeviceProperties2 glad_vkGetPhysicalDeviceProperties2 = NULL;
PFN_vkGetPhysicalDeviceQueueFamilyProperties
    glad_vkGetPhysicalDeviceQueueFamilyProperties = NULL;
PFN_vkGetPhysicalDeviceQueueFamilyProperties2
    glad_vkGetPhysicalDeviceQueueFamilyProperties2 = NULL;
PFN_vkGetPhysicalDeviceSparseImageFormatProperties
    glad_vkGetPhysicalDeviceSparseImageFormatProperties = NULL;
PFN_vkGetPhysicalDeviceSparseImageFormatProperties2
    glad_vkGetPhysicalDeviceSparseImageFormatProperties2 = NULL;
PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR
    glad_vkGetPhysicalDeviceSurfaceCapabilitiesKHR = NULL;
PFN_vkGetPhysicalDeviceSurfaceFormatsKHR
    glad_vkGetPhysicalDeviceSurfaceFormatsKHR = NULL;
PFN_vkGetPhysicalDeviceSurfacePresentModesKHR
    glad_vkGetPhysicalDeviceSurfacePresentModesKHR = NULL;
PFN_vkGetPhysicalDeviceSurfaceSupportKHR
    glad_vkGetPhysicalDeviceSurfaceSupportKHR = NULL;
PFN_vkGetPhysicalDeviceToolProperties glad_vkGetPhysicalDeviceToolProperties =
    NULL;
...
static void glad_vk_load_VK_VERSION_1_0(GLADuserptrloadfunc load,
  ...
  glad_vkCmdClearDepthStencilImage = (PFN_vkCmdClearDepthStencilImage)load(
  ...
  glad_vkCmdSetStencilCompareMask = (PFN_vkCmdSetStencilCompareMask)load(
  ...
  glad_vkCreateDescriptorSetLayout = (PFN_vkCreateDescriptorSetLayout)load(
  ...
  glad_vkDestroyDescriptorSetLayout = (PFN_vkDestroyDescriptorSetLayout)load(
  ...
  glad_vkEnumeratePhysicalDevices = (PFN_vkEnumeratePhysicalDevices)load(
  ...
  glad_vkGetBufferMemoryRequirements = (PFN_vkGetBufferMemoryRequirements)load(
      userptr, "vkGetBufferMemoryRequirements");
  glad_vkGetDeviceMemoryCommitment = (PFN_vkGetDeviceMemoryCommitment)load(
  ...
  glad_vkGetImageMemoryRequirements = (PFN_vkGetImageMemoryRequirements)load(
  ...
  glad_vkGetImageSubresourceLayout = (PFN_vkGetImageSubresourceLayout)load(
  ...
  glad_vkGetPhysicalDeviceFeatures = (PFN_vkGetPhysicalDeviceFeatures)load(
  ...
  glad_vkGetPhysicalDeviceProperties = (PFN_vkGetPhysicalDeviceProperties)load(
  ...
  glad_vkGetRenderAreaGranularity = (PFN_vkGetRenderAreaGranularity)load(
...
static void glad_vk_load_VK_VERSION_1_1(GLADuserptrloadfunc load,
  ...
  glad_vkEnumerateInstanceVersion = (PFN_vkEnumerateInstanceVersion)load(
  ...
  glad_vkGetImageMemoryRequirements2 = (PFN_vkGetImageMemoryRequirements2)load(
  ...
  glad_vkGetPhysicalDeviceFeatures2 = (PFN_vkGetPhysicalDeviceFeatures2)load(
...
static void glad_vk_load_VK_VERSION_1_2(GLADuserptrloadfunc load,
  ...
  glad_vkGetBufferOpaqueCaptureAddress =
...
static int glad_vk_get_extensions(VkPhysicalDevice physical_device,
  ...
  if (glad_vkEnumerateInstanceExtensionProperties == NULL ||
  ...
  if (physical_device != NULL) {
    result = glad_vkEnumerateDeviceExtensionProperties(
...
static int glad_vk_find_extensions_vulkan(VkPhysicalDevice physical_device) {
  ...
  GLAD_VK_EXT_debug_report =
      glad_vk_has_extension("VK_EXT_debug_report", extension_count, extensions);
  GLAD_VK_KHR_portability_enumeration = glad_vk_has_extension(
...
int gladLoadVulkan(VkPhysicalDevice physical_device, GLADloadfunc load) {
  return gladLoadVulkanUserPtr(physical_device, glad_vk_get_proc_from_userptr,
