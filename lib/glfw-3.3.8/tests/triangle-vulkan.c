    0x00000010, 0x00000003, 0x00040015, 0x00000011, 0x00000020, 0x00000001,
    0x0004002b, 0x00000011, 0x00000012, 0x00000000, 0x00040020, 0x00000013,
    0x00000001, 0x0000000d, 0x0004003b, 0x00000013, 0x00000014, 0x00000001,
    0x00040020, 0x00000016, 0x00000003, 0x0000000d, 0x00050036, 0x00000002,
    ...
    0x0004003d, 0x0000000d, 0x00000015, 0x00000014, 0x00050041, 0x00000016,
    0x00000017, 0x00000010, 0x00000012, 0x0003003e, 0x00000017, 0x00000015,
...
static void demo_flush_init_cmd(struct demo *demo) {
  ...
  if (demo->setup_cmd == VK_NULL_HANDLE) return;
...
static void demo_set_image_layout(struct demo *demo, VkImage image,
  ...
  vkCmdPipelineBarrier(demo->setup_cmd, src_stages, dest_stages, 0, 0, NULL, 0,
...
static void demo_prepare_buffers(struct demo *demo) {
  ...
  err = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(demo->gpu, demo->surface,
                                                  &surfCapabilities);
  assert(!err);

  uint32_t presentModeCount;
  err = vkGetPhysicalDeviceSurfacePresentModesKHR(demo->gpu, demo->surface,
  ...
  err = vkGetSwapchainImagesKHR(demo->device, demo->swapchain,
                                &demo->swapchainImageCount, swapchainImages);
  assert(!err);
...
static void demo_prepare_texture_image(struct demo *demo,
  ...
  if (required_props & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT) {
    ...
    err = vkMapMemory(demo->device, tex_obj->mem, 0, mem_alloc.allocationSize,
                      0, &data);
    assert(!err);

    for (y = 0; y < tex_height; y++) {
      uint32_t *row = (uint32_t *)((char *)data + layout.rowPitch * y);
      for (x = 0; x < tex_width; x++) row[x] = tex_colors[(x & 1) ^ (y & 1)];
    }
  ...
  for (i = 0; i < DEMO_TEXTURE_COUNT; i++) {
    if ((props.linearTilingFeatures & VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT) &&
      ...
      demo_prepare_texture_image(
          demo, tex_colors[i], &demo->textures[i], VK_IMAGE_TILING_OPTIMAL,
          (VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT),
          VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);

      demo_set_image_layout(
          demo, staging_texture.image, VK_IMAGE_ASPECT_COLOR_BIT,
          staging_texture.imageLayout, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, 0);
      ...
      vkCmdCopyImage(demo->setup_cmd, staging_texture.image,
...
static void demo_prepare_vertices(struct demo *demo) {
  ...
  err = vkBindBufferMemory(demo->device, demo->vertices.buf, demo->vertices.mem,
                           0);
  assert(!err);
...
static void demo_key_callback(GLFWwindow *window, int key, int scancode,
                              int action, int mods) {
...
static void demo_run(struct demo *demo) {
  while (!glfwWindowShouldClose(demo->window)) {
    ...
    if (demo->depthStencil > 0.99f) demo->depthIncrement = -0.001f;
...
static void demo_init_vk(struct demo *demo) {
  ...
  gladLoadVulkanUserPtr(
      demo->gpu, (GLADuserptrloadfunc)glfwGetInstanceProcAddress, demo->inst);
