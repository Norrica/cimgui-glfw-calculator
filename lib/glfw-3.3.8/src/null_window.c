...
int _glfwPlatformWindowMaximized(_GLFWwindow* window) { return GLFW_FALSE; }
...
const char* _glfwPlatformGetClipboardString(void) { return NULL; }

const char* _glfwPlatformGetScancodeName(int scancode) { return ""; }
